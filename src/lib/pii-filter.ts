...
// Phone: (xxx) xxx-xxxx with optional space after area code
...
// Date of birth: "Date of birth: M/D/YYYY" or "DOB: M/D/YYYY" patterns
const DOB_CONTEXT_PATTERN =
  /(?:Date of birth|DOB)[:\s]*\d{1,2}\/\d{1,2}\/\d{4}/gi
